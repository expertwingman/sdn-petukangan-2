  ...
  return (
    <div className="min-h-screen pt-24 pb-16 px-4">
      <div className="max-w-4xl mx-auto glass-card p-8 md:p-12 animate-fade-in-up">
        <h1 className="text-3xl md:text-4xl font-bold text-primary mb-6">Hubungi Kami</h1>
        <div className="prose prose-lg prose-primary max-w-none text-gray-700 leading-relaxed">
          <p>📞 Telepon: (021) 1234567<br />📧 Email: info@sdnpetukanganselatan02.sch.id<br />🏫 Alamat: Jl. Sakti VII RT.06/01, Pesanggrahan, Jakarta Selatan 12340<br /><br />Jam operasional: Senin-Jumat, 07:00 - 16:00 WIB.</p>
        </div>
        <div className="mt-8">
