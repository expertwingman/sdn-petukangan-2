...
export default function GuruPage() {
  return (
    <main className="max-w-6xl mx-auto p-6 py-12">
      <h1 className="text-3xl font-bold text-blue-900 mb-8">Guru & Staf Pengajar</h1>
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        {teachers.map((guru) => (
          <div key={guru.nip} className="bg-white rounded-lg shadow-md overflow-hidden border border-gray-200">
