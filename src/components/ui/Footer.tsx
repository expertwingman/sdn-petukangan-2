        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="flex space-x-4">
              <a href="#" className="text-2xl text-gray-400 hover:text-blue-400 transition">📸</a>
              <a href="#" className="text-2xl text-gray-400 hover:text-red-500 transition">▶️</a>
              <a href="#" className="text-2xl text-gray-400 hover:text-blue-600 transition">📘</a>
            </div>
